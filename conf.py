...
BLOG_EMAIL = "zaki@cs.rpi.edu"
BLOG_DESCRIPTION = "Home Page"  # (translatable)
...
NAVIGATION_ALT_LINKS = {
    DEFAULT_LANG: (
        # ("/courses/mlib/index.html", "MLinBioinfo"),
    )
}
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-11058802-2"></script>
<script>
